...
import com.project.neurovice_backend.user.service.AssessmentService;
...
public class AssessmentController {
    ...
    public ResponseEntity<StartAssessmentResponse> startAssessment(
        ...
        if (id == null) {
            throw new com.project.neurovice_backend.user.exception.BadRequestException("childId is required");
        }
